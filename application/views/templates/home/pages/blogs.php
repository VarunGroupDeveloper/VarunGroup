                          ...
                          <div class="row g-4">
                              ...
                              <article class="rs-postbox-item">
                                <div class="rs-postbox-thumb">
                                    <a href="blog-details.html">
                                        <img src="assets/images/news/thumbanil-9.webp" alt="image">
                                    </a>
                                </div>
                                <div class="rs-postbox-content">
                                    <div class="rs-postbox-meta-list">
                                        ...
                                        <div class="rs-postbox-meta-item">
                                            <span class="rs-postbox-meta-text"><a href="blog-details.html">June 2014</a></span>
                                        </div>
                                    </div>
                                    <h5 class="rs-postbox-title">
                                        <a href="blog-details.html">Varun Group setting up 5-star hotel in Vijayawada.</a>
                                    </h5>
                                </div>
                              </article>
                            </div>
                            <div class="col-md-6">
                              <article class="rs-postbox-item">
                                <div class="rs-postbox-thumb">
                                    <a href="blog-details.html">
                                        <img src="assets/images/news/thumbanil-10.webp" alt="image">
                                    </a>
                                </div>
                                <div class="rs-postbox-content">
                                    <div class="rs-postbox-meta-list">
                                        <div class="rs-postbox-meta-item">
                                            <span class="rs-postbox-meta-text"><a href="blog-details.html">2010</a></span>
                                        </div>
                                    </div>
                                    <h5 class="rs-postbox-title">
                                        <a href="blog-details.html">Visakhapatnam’s Largest Hotel.</a>
                                    </h5>
                                </div>
                              </article>
                            </div>
