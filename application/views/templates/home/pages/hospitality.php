                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Hospitality</h1>
                            </div>
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        ...
                        Services
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Dining Options</h2>
                        </div>
                    </div>
                </div>
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        ...
                        Services
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Indulge your palate at our signature restaurants:</h2>
                        </div>
                    </div>
                   
                </div>
                <div class="row g-5">
                    <div class="col-xxl-3 col-xl-4 col-lg-4 order-1 order-lg-0">
                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-item-one-tab" data-bs-toggle="pill" data-bs-target="#pills-item-one" type="button" role="tab" aria-controls="pills-item-one" aria-selected="true">
                                       The Square <span class="rs-services-icon"><svg
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-two-tab" data-bs-toggle="pill" data-bs-target="#pills-item-two" type="button" role="tab" aria-controls="pills-item-two" aria-selected="false"> Harbour Vue <span class="rs-services-icon"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12"
                                    fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                       d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-three-tab" data-bs-toggle="pill" data-bs-target="#pills-item-three" type="button" role="tab" aria-controls="pills-item-three" aria-selected="false">
                                        Zaffran<span class="rs-services-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-four-tab" data-bs-toggle="pill" data-bs-target="#pills-item-four" type="button" role="tab" aria-controls="pills-item-four" aria-selected="false">
                                        Red Bowl<span class="rs-services-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="18" height="12" viewBox="0 0 18 12" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                       d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                                       fill="white"></path>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-item-five-tab" data-bs-toggle="pill" data-bs-target="#pills-item-five" type="button" role="tab" aria-controls="pills-item-five" aria-selected="false">
                                       Sugarr<span class="rs-services-icon"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12"
                                    fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                       d="M0 6C0 5.66249 0.273604 5.38889 0.611111 5.38889L15.0246 5.38889L11.179 1.54323C10.9403 1.30458 10.9403 0.917645 11.179 0.678991C11.4176 0.440337 11.8046 0.440337 12.0432 0.678991L16.9321 5.56788C17.1708 5.80653 17.1708 6.19347 16.9321 6.43212L12.0432 11.321C11.8046 11.5597 11.4176 11.5597 11.179 11.321C10.9403 11.0824 10.9403 10.6954 11.179 10.4568L15.0246 6.61111L0.611111 6.61111C0.273604 6.61111 0 6.33751 0 6Z"
                    ...
                    <div class="col-xxl-9 col-xl-8 col-lg-8 orader-0 order-lg-1">
                                        ...
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    ...
                                                    <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                                    ...
                                                    <div class="rs-services-tab-btn">
                                                        <a class="rs-btn has-text has-icon" href="services-details.html">Read More
                                                            <span class="icon-box">
                                ...
                                <div class="tab-pane fade" id="pills-item-two" role="tabpanel" aria-labelledby="pills-item-two-tab" tabindex="0">
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">A high regulation industry refers </h3>
                                                    <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                                        printer took a galley. </p>
                                                    <div class="rs-services-tab-list">
                                                        <ul>
                                ...
                                <div class="tab-pane fade" id="pills-item-three" role="tabpanel" aria-labelledby="pills-item-three-tab" tabindex="0">
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Bridge construction is a complex engineering
                                                    </h3>
                                                    <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                                        printer took a galley. </p>
                                                    <div class="rs-services-tab-list">
                                ...
                                <div class="tab-pane fade" id="pills-item-four" role="tabpanel" aria-labelledby="pills-item-four-tab" tabindex="0">
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">The oil and gas energy sector is a crucial
                                                    </h3>
                                                    <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                                        printer took a galley. </p>
                                                    <div class="rs-services-tab-list">
                                ...
                                <div class="tab-pane fade" id="pills-item-five" role="tabpanel" aria-labelledby="pills-item-five-tab" tabindex="0">
                                    <div class="rs-services-tab-content-wrapper p-relative">
                                        <div class="row g-5 align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="rs-services-tab-content">
                                                    <h3 class="rs-services-tab-title">Mechanical engineering is a broad field</h3>
                                                    <p>The industry’s standard dummy text ever since the 1500s, when an unknown
                                                        printer took a galley. </p>
                                                    <div class="rs-services-tab-list">
                                                        <ul>
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        ...
                        Advance Tab
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade elements-title">Tab Style 01</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              About Us
                                    ...
                                    <h3 class="rs-section-title rs-split-text-enable split-in-fade">Explore our casual and vibrant restaurant spaces:</h3>
                              ...
                              <div class="rs-about-tab">
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pill-item-one-tab" data-bs-toggle="pill" data-bs-target="#pill-item-one" type="button" role="tab" aria-controls="pills-item-one" aria-selected="true">
                                          Varun Eats – Rushikonda
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pill-item-two-tab" data-bs-toggle="pill" data-bs-target="#pill-item-two" type="button" role="tab" aria-controls="pills-item-two" aria-selected="false"> Varun Eats – Beach Road
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                            ...
                            <div class="rs-aobut-tab-content-wrapper">
                                <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pill-item-one" role="tabpanel" aria-labelledby="pill-item-one-tab" tabindex="0">
                                    ...
                                    <div class="tab-pane fade" id="pill-item-two" role="tabpanel" aria-labelledby="pill-item-two-tab" tabindex="0">
                                        <section class="rs-portfolio-area rs-portfolio-four rs-portfolio-tooltip rs-swiper">
                                            <div class="container">
                                                <div class="row  g-5 section-title-space align-items-end">
                                    ...
                                    <div class="tab-pane fade" id="pill-item-three" role="tabpanel" aria-labelledby="pill-item-three-tab" tabindex="0">
                                        <section class="rs-portfolio-area rs-portfolio-four rs-portfolio-tooltip rs-swiper">
                                            <div class="container">
                                                <div class="row  g-5 section-title-space align-items-end">
                                ...
                                <div class="rs-about-author-info">
                                    <div class="rs-about-btn">
                                        <a class="rs-btn has-theme-light-green has-icon has-bg" href="about.html">Explore More
                                            <span class="icon-box">
        ...
        <section class="rs-protfolio-area section-space rs-portfolio-six">
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-8 col-lg-8">
                        ...
                        Recent Project
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">some of our finished projects that
                                will amaze your industry</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="rs-portfolio-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-portfolio-content">
                                ...
                                <div class="rs-services-btn-wrapper">
                                    ...
                                    <a class="rs-square-btn has-icon has-light-bg has-black" href="portfolio-details.html">
                                        <span class="icon-box">
                ...
                <div class="row">
                    <div class="col-12">
                        <h6 class="rs-portfolio-text-link text-center">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-tab">
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="Vijayawada-item-one-tab" data-bs-toggle="pill" data-bs-target="#Vijayawada-item-one" type="button" role="tab" aria-controls="Vijayawada-item-one" aria-selected="true">
                                          Vijayawada
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                            ...
                            <div class="rs-aobut-tab-content-wrapper">
                                <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="Vijayawada-item-one" role="tabpanel" aria-labelledby="Vijayawada-item-one-tab" tabindex="0">
                                        <section class="rs-portfolio-area rs-portfolio-four rs-portfolio-tooltip rs-swiper">
                                            <div class="container">
                                                <div class="row  g-5 section-title-space align-items-end">
                                    ...
                                    <div class="tab-pane fade" id="Visakhapatnam-item-two" role="tabpanel" aria-labelledby="Visakhapatnam-item-two-tab" tabindex="0">
                                        <section class="rs-portfolio-area rs-portfolio-four rs-portfolio-tooltip rs-swiper">
                                            <div class="container">
                                                <div class="row  g-5 section-title-space align-items-end">
                        ...
                        <div class="rs-category-item">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_5" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m183.976 364.527c-2.105 0-4.198-.853-5.716-2.547-1.361-1.513-32.925-37.83 3.55-105.862 7.858-14.656 9.745-27.716 5.607-38.815-1.258-3.363-.036-7.144 2.946-9.14 2.982-2.002 6.95-1.675 9.575.762.617.574 9.636 9.11 16.477 24.074 7.712-23.336 22.738-50.659 51.494-57.954 2.915-.726 5.982.279 7.881 2.595 1.905 2.316 2.299 5.529 1.016 8.239-.176.363-16.786 36.649.066 46.007 28.902 16.06 15.449 61.245 14.862 63.163-1.252 4.089-5.571 6.376-9.66 5.129-4.083-1.24-6.388-5.564-5.148-9.654.103-.351 10.114-35.277-7.579-45.1-17.1-9.503-17.511-30.081-13.132-47.726-27.286 21.062-32.101 72.061-32.156 72.659-.363 4.162-3.969 7.24-8.124 7.052-4.168-.224-7.41-3.708-7.331-7.882.205-10.506-2.033-19.64-5.045-27.093-1.536 6.775-4.234 13.78-8.105 21.001-31.031 57.882-6.697 87.025-5.644 88.235 2.783 3.212 2.487 8.093-.701 10.906-1.473 1.31-3.306 1.951-5.133 1.951z">
                                        </path>
                                        <path d="m306.551 364.544c-1.7 0-3.411-.556-4.845-1.706-3.333-2.68-3.864-7.555-1.186-10.888 30.233-37.623 18.346-80.426 12.528-95.748-14.517 5.021-17.802 15.685-17.947 16.193-1.192 4.059-5.431 6.472-9.514 5.347-4.083-1.131-6.515-5.275-5.438-9.37.248-.949 6.412-23.264 35.936-28.962 3.473-.641 6.859 1.053 8.408 4.162 1.289 2.607 31.182 64.457-11.898 118.08-1.532 1.901-3.776 2.892-6.044 2.892z">
                                        </path>
                                        <path d="m421.213 394.898h-342.427c-4.276 0-7.743-3.466-7.743-7.743v-30.353c0-4.276 3.466-7.743 7.743-7.743h342.427c4.277 0 7.743 3.466 7.743 7.743v30.353c0 4.277-3.466 7.743-7.743 7.743zm-334.684-15.486h326.941v-14.868h-326.941z">
                                        </path>
                                        <path d="m454.663 473.805h-409.326c-4.277 0-7.743-3.466-7.743-7.742v-78.908c0-4.276 3.466-7.743 7.743-7.743h409.327c4.276 0 7.743 3.466 7.743 7.743v78.908c-.001 4.276-3.467 7.742-7.744 7.742zm-401.585-15.485h393.842v-63.423h-393.842z">
                                        </path>
                                        <path d="m454.663 473.805h-409.326c-4.277 0-7.743-3.466-7.743-7.742v-39.457c0-4.277 3.466-7.743 7.743-7.743h409.327c4.276 0 7.743 3.466 7.743 7.743v39.457c-.001 4.276-3.467 7.742-7.744 7.742zm-401.585-15.485h393.842v-23.972h-393.842z">
                                        </path>
                                        <path d="m444.828 394.898h-389.656c-4.277 0-7.743-3.466-7.743-7.743v-321.34c0-4.276 3.466-7.742 7.743-7.742h389.656c4.276 0 7.743 3.466 7.743 7.742v321.34c0 4.277-3.467 7.743-7.743 7.743zm-381.913-15.486h374.171v-305.855h-374.171z">
                                        </path>
                                        <path d="m399.963 73.557h-299.92c-4.277 0-7.743-3.466-7.743-7.743v-31.876c0-4.277 3.466-7.743 7.743-7.743h299.921c4.277 0 7.743 3.466 7.743 7.743v31.877c-.001 4.277-3.467 7.742-7.744 7.742zm-292.178-15.484h284.436v-16.393h-284.436z">
                                        </path>
                                        <path d="m366.507 364.544h-233.015c-4.276 0-7.743-3.466-7.743-7.743v-117.014c0-68.516 55.741-124.256 124.25-124.256s124.249 55.74 124.249 124.256v117.015c.001 4.277-3.464 7.742-7.741 7.742zm-225.272-15.485h217.53v-109.272c0-59.975-48.79-108.771-108.765-108.771s-108.765 48.796-108.765 108.771z">
                                        </path>
                                        <path d="m467.257 473.805h-434.514c-4.277 0-7.743-3.466-7.743-7.742 0-4.277 3.466-7.743 7.743-7.743h434.515c4.276 0 7.743 3.466 7.743 7.743-.001 4.276-3.468 7.742-7.744 7.742z">
                                        </path>
                                        <path d="m357.682 114.866h-12.927c-4.276 0-7.742-3.466-7.742-7.743s3.466-7.743 7.742-7.743h12.927c4.277 0 7.743 3.466 7.743 7.743-.001 4.276-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m403.617 146.03h-9c-4.277 0-7.743-3.467-7.743-7.743 0-4.277 3.466-7.743 7.743-7.743h9c4.276 0 7.743 3.466 7.743 7.743 0 4.276-3.467 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m407.313 194.045h-21.698c-4.276 0-7.743-3.466-7.743-7.743 0-4.276 3.467-7.742 7.743-7.742h21.698c4.276 0 7.743 3.466 7.743 7.742 0 4.277-3.467 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m421.213 231.209h-8.13c-4.276 0-7.743-3.466-7.743-7.743 0-4.276 3.467-7.742 7.743-7.742h8.13c4.277 0 7.743 3.466 7.743 7.742 0 4.277-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m411.009 271.833h-11.893c-4.276 0-7.743-3.466-7.743-7.742 0-4.277 3.467-7.743 7.743-7.743h11.893c4.276 0 7.742 3.466 7.742 7.743 0 4.276-3.466 7.742-7.742 7.742z">
                                        </path>
                                        <path d="m419.084 312.924h-11.771c-4.277 0-7.743-3.466-7.743-7.743s3.466-7.743 7.743-7.743h11.771c4.277 0 7.743 3.466 7.743 7.743-.001 4.276-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m155.244 114.866h-12.926c-4.277 0-7.743-3.466-7.743-7.743s3.466-7.743 7.743-7.743h12.926c4.277 0 7.743 3.466 7.743 7.743 0 4.276-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m105.383 146.03h-9c-4.277 0-7.743-3.467-7.743-7.743 0-4.277 3.466-7.743 7.743-7.743h9c4.276 0 7.743 3.466 7.743 7.743 0 4.276-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m114.384 194.045h-21.697c-4.277 0-7.743-3.466-7.743-7.743 0-4.276 3.466-7.742 7.743-7.742h21.697c4.277 0 7.743 3.466 7.743 7.742-.001 4.277-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m86.916 231.209h-8.13c-4.276 0-7.743-3.466-7.743-7.743 0-4.276 3.466-7.742 7.743-7.742h8.13c4.277 0 7.743 3.466 7.743 7.742 0 4.277-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m100.883 271.833h-11.892c-4.276 0-7.743-3.466-7.743-7.742 0-4.277 3.466-7.743 7.743-7.743h11.892c4.277 0 7.743 3.466 7.743 7.743-.001 4.276-3.466 7.742-7.743 7.742z">
                                        </path>
                                        <path d="m92.687 312.924h-11.772c-4.276 0-7.743-3.466-7.743-7.743s3.466-7.743 7.743-7.743h11.771c4.276 0 7.743 3.466 7.743 7.743.001 4.276-3.466 7.743-7.742 7.743z">
                                        </path>
                                        <path d="m259.26 102.574h-18.522c-4.276 0-7.743-3.466-7.743-7.743 0-4.276 3.467-7.743 7.743-7.743h18.522c4.277 0 7.743 3.466 7.743 7.743s-3.466 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m118.54 473.805c-4.276 0-7.743-3.466-7.743-7.742v-39.457c0-4.277 3.466-7.743 7.743-7.743s7.743 3.466 7.743 7.743v39.457c-.001 4.276-3.466 7.742-7.743 7.742z">
                                        </path>
                                        <path d="m188.712 434.349c-4.276 0-7.743-3.466-7.743-7.743v-39.451c0-4.276 3.466-7.743 7.743-7.743s7.743 3.466 7.743 7.743v39.451c0 4.276-3.465 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m248.04 473.805c-4.277 0-7.743-3.466-7.743-7.742v-39.457c0-4.277 3.466-7.743 7.743-7.743 4.276 0 7.743 3.466 7.743 7.743v39.457c0 4.276-3.467 7.742-7.743 7.742z">
                                        </path>
                                        <path d="m318.673 434.349c-4.277 0-7.743-3.466-7.743-7.743v-39.451c0-4.276 3.466-7.743 7.743-7.743 4.276 0 7.743 3.466 7.743 7.743v39.451c-.001 4.276-3.467 7.743-7.743 7.743z">
                                        </path>
                                        <path d="m385.155 473.805c-4.276 0-7.742-3.466-7.742-7.742v-39.457c0-4.277 3.466-7.743 7.742-7.743 4.277 0 7.743 3.466 7.743 7.743v39.457c0 4.276-3.466 7.742-7.743 7.742z">
                                        </path>
                                    </g>
                                </svg>
                            </div>
                        ...
                        <div class="rs-category-item">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_6" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m169.348 445.426h-122.733c-4.133 0-7.482-3.349-7.482-7.482v-276.414c0-4.133 3.349-7.482 7.482-7.482h122.733c4.133 0 7.482 3.349 7.482 7.482v276.414c0 4.133-3.349 7.482-7.482 7.482zm-115.251-14.963h107.769v-261.453h-107.769z">
                                        </path>
                                        <path d="m330.646 445.426h-161.298c-4.132 0-7.482-3.349-7.482-7.482v-138.61c0-4.133 3.35-7.482 7.482-7.482h161.298c4.132 0 7.482 3.349 7.482 7.482v138.61c0 4.133-3.35 7.482-7.482 7.482zm-153.816-14.963h146.335v-123.648h-146.335z">
                                        </path>
                                        <path d="m281.706 445.426h-63.412c-4.132 0-7.482-3.349-7.482-7.482v-54.495c0-4.132 3.35-7.482 7.482-7.482h63.412c4.133 0 7.482 3.35 7.482 7.482v54.495c0 4.133-3.349 7.482-7.482 7.482zm-55.93-14.963h48.449v-39.533h-48.449z">
                                        </path>
                                        <path d="m330.646 306.815h-161.298c-4.132 0-7.482-3.35-7.482-7.482v-27.972c0-4.132 3.35-7.482 7.482-7.482h161.298c4.132 0 7.482 3.35 7.482 7.482v27.972c0 4.133-3.35 7.482-7.482 7.482zm-153.816-14.963h146.335v-13.008h-146.335z">
                                        </path>
                                        <path d="m288.328 278.844h-76.657c-2.186 0-4.261-.956-5.681-2.615-1.421-1.66-2.046-3.858-1.713-6.014l20.458-131.533c.566-3.644 3.706-6.333 7.393-6.333h35.742c3.688 0 6.827 2.689 7.394 6.333l20.457 131.533c.333 2.156-.292 4.355-1.713 6.014-1.418 1.659-3.494 2.615-5.68 2.615zm-67.924-14.964h59.192l-18.131-116.57h-22.93z">
                                        </path>
                                        <path d="m72.619 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482s7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482s7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m72.619 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482s7.482 3.35 7.482 7.482v9.843c0 4.133-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.132-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482s7.482 3.35 7.482 7.482v9.843c0 4.134-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m96.192 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482s7.482 3.349 7.482 7.482v9.843c0 4.133-3.35 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m119.771 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m214.635 353.151c-4.132 0-7.482-3.349-7.482-7.481v-9.844c0-4.132 3.35-7.482 7.482-7.482s7.482 3.35 7.482 7.482v9.844c0 4.132-3.35 7.481-7.482 7.481z">
                                        </path>
                                        <path d="m238.214 353.151c-4.132 0-7.482-3.349-7.482-7.481v-9.844c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.844c-.001 4.132-3.35 7.481-7.482 7.481z">
                                        </path>
                                        <path d="m261.786 353.151c-4.132 0-7.482-3.349-7.482-7.481v-9.844c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.844c0 4.132-3.349 7.481-7.482 7.481z">
                                        </path>
                                        <path d="m285.359 353.151c-4.132 0-7.482-3.349-7.482-7.481v-9.844c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.844c0 4.132-3.349 7.481-7.482 7.481z">
                                        </path>
                                        <path d="m143.344 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m143.344 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m453.385 445.426h-122.739c-4.132 0-7.482-3.349-7.482-7.482v-276.414c0-4.133 3.35-7.482 7.482-7.482h122.738c4.133 0 7.482 3.349 7.482 7.482v276.414c0 4.133-3.348 7.482-7.481 7.482zm-115.257-14.963h107.776v-261.453h-107.776z">
                                        </path>
                                        <path d="m427.38 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m427.38 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m403.802 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m380.229 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 203.867c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 239.957c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 276.047c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 312.14c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 348.23c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.132-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 384.322c-4.132 0-7.482-3.349-7.482-7.482v-9.843c0-4.132 3.35-7.482 7.482-7.482 4.133 0 7.482 3.35 7.482 7.482v9.843c0 4.134-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m356.656 420.412c-4.132 0-7.482-3.35-7.482-7.482v-9.843c0-4.133 3.35-7.482 7.482-7.482 4.133 0 7.482 3.349 7.482 7.482v9.843c0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m467.518 445.426h-435.036c-4.132 0-7.482-3.349-7.482-7.482 0-4.132 3.35-7.481 7.482-7.481h435.037c4.132 0 7.482 3.349 7.482 7.481-.001 4.133-3.351 7.482-7.483 7.482z">
                                        </path>
                                        <path d="m274.633 189.22h-49.021c-4.133 0-7.482-3.349-7.482-7.482 0-4.132 3.349-7.482 7.482-7.482h49.021c4.133 0 7.482 3.35 7.482 7.482 0 4.133-3.349 7.482-7.482 7.482z">
                                        </path>
                                        <path d="m247.963 146.393c-2.431 0-4.816-1.183-6.254-3.364-3.951-5.997-6.038-12.967-6.038-20.165 0-14.952 9.136-28.205 22.521-33.808-.018-.424-.03-.848-.03-1.269 0-18.315 14.899-33.214 33.217-33.214 6.897 0 13.444 2.096 18.973 5.994 6.049-3.898 13.057-5.994 20.294-5.994 20.837 0 37.794 16.954 37.794 37.791 0 20.838-16.957 37.791-37.794 37.791-7.879 0-15.414-2.446-21.679-6.839-.082 6.433-1.847 12.731-5.126 18.239-2.11 3.557-6.71 4.717-10.252 2.607-3.553-2.11-4.716-6.701-2.607-10.252 1.976-3.326 3.022-7.145 3.022-11.047 0-2.656-.532-5.342-1.578-7.979-.76-1.917-.696-4.063.181-5.93.871-1.868 2.479-3.291 4.436-3.936 1.765-.579 3.179-1.23 4.331-1.99 3.426-2.253 8.032-1.345 10.322 2.063 4.267 6.325 11.351 10.1 18.95 10.1 12.59 0 22.831-10.24 22.831-22.828 0-12.587-10.24-22.827-22.831-22.827-5.699 0-11.187 2.186-15.466 6.158-3.01 2.791-7.733 2.636-10.544-.359-3.513-3.738-8.218-5.798-13.257-5.798-10.065 0-18.253 8.189-18.253 18.251 0 1.341.216 2.803.69 4.606.514 1.99.192 4.109-.9 5.856-1.093 1.745-2.859 2.961-4.875 3.364-10.088 2.017-17.406 10.953-17.406 21.249 0 4.261 1.233 8.388 3.571 11.93 2.273 3.451 1.321 8.092-2.133 10.366-1.269.837-2.695 1.234-4.11 1.234z">
                                        </path>
                                    </g>
                                </svg>
                            </div>
