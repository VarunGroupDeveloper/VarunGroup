            ...
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="fade" data-delay="1000" data-item="1" data-margin="30" data-margin-xl="30" data-margin-lg="30" data-margin-md="30" data-margin-sm="30" data-margin-xs="30" data-margin-mobile="30">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/business/business-banner.webp">
                                </div>
                                     <div class="container">
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-8 col-lg-8">
        ...
        <!-- gsap style 05 -->
        <section class="rs-elements-gsap-area sticky-marquee-section">
          <div class="rs-gsap-slide-wrapper">
            <div class="rs-gsap-slide-inner">
              <div class="rs-gsap-slide-item marquee-text">
                <p class="rs-white">Infrastructure | Innovation | Sustainability | Quality | Trust | On-Time Delivery</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="rs-protfolio-area section-space rs-portfolio-six">
            <div class="rs-portfolio-bg-thumb" ></div>
            <div class="container">
                <div class="row g-5">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        ...
                        Our Services
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">We Provide Our Services All Over The World</h2>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-services-bg-thumb" data-background="assets/images/bg/services-bg-03.png"></div>
                            ...
                            <div class="rs-services-content">
                                ...
                                <p class="descrip">Offering both design and construct services under one contract, stream the
        ...
        <section class="rs-why-choose-area section-space-bottom rs-why-choose-one primary-bg">
            <div class="container">
        ...
        <!-- why choose area end -->
                       <!-- category area start -->
        <section class="rs-category-area rs-category-one section-space-bottom primary-bg">
            <div class="rs-category-bg-thumb" ></div>
            <div class="container">
                <div class="row  process-counts g-5">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay=".3s">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white">31+</h5>
                                <p class="descrip rs-white">Years of excellance </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay=".5s">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m250.015 431.812c-1.224 0-2.441-.285-3.56-.858-43.353-22.264-145.305-92.798-155.707-266.514-.176-2.934 1.321-5.722 3.865-7.2l151.47-88.003c2.423-1.399 5.404-1.399 7.827 0l151.476 88.003c2.544 1.479 4.041 4.266 3.865 7.206-10.408 173.746-112.335 244.256-155.676 266.507-1.119.573-2.336.859-3.56.859zm-143.399-263.525c11.138 157.654 101.093 224.183 143.399 246.934 42.299-22.745 132.225-89.249 143.37-246.934l-143.388-83.304z">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white">32</h5>
                                <p class="descrip rs-white">States & Union Territories</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay=".7s">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_3" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m306.845 474.732h-256.403c-2.435 0-4.73-1.138-6.203-3.074-1.474-1.942-1.958-4.456-1.306-6.8l38.314-138.156v-108.46c0-4.303 3.488-7.792 7.792-7.792h179.207c4.303 0 7.792 3.489 7.792 7.792v108.461l38.315 138.156c.651 2.344.167 4.858-1.306 6.8-1.473 1.935-3.767 3.073-6.202 3.073zm-246.154-15.583h235.905l-35.858-129.305c-.188-.676-.283-1.376-.283-2.082v-101.728h-163.623v101.728c0 .707-.094 1.406-.283 2.082z">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white">1613</h5>
                                <p class="descrip rs-white">Branches</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay=".9s">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_4" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m168.653 455.801h-110.765c-6.045 0-11.718-2.965-15.56-8.139-4.577-6.153-5.935-14.367-3.647-21.973l17.026-56.584c2.779-9.238 10.502-15.445 19.212-15.445h76.701c8.705 0 16.427 6.207 19.207 15.445l17.032 56.584c2.289 7.611.919 15.825-3.653 21.978-3.841 5.169-9.514 8.134-15.553 8.134zm-93.733-87.528c-2.181 0-4.327 2.075-5.217 5.045l-17.026 56.584c-1.136 3.773-.034 7.146 1.375 9.044.759 1.025 2.044 2.243 3.836 2.243h110.765c1.786 0 3.07-1.219 3.83-2.241 1.41-1.9 2.517-5.276 1.382-9.049l-17.032-56.582c-.89-2.97-3.037-5.045-5.211-5.045h-76.702z">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white">₹1.99 Lakh Cr</h5>
                                <p class="descrip rs-white">Assets Under Management</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay="1.1s">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_5" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m183.976 364.527c-2.105 0-4.198-.853-5.716-2.547-1.361-1.513-32.925-37.83 3.55-105.862 7.858-14.656 9.745-27.716 5.607-38.815-1.258-3.363-.036-7.144 2.946-9.14 2.982-2.002 6.95-1.675 9.575.762.617.574 9.636 9.11 16.477 24.074 7.712-23.336 22.738-50.659 51.494-57.954 2.915-.726 5.982.279 7.881 2.595 1.905 2.316 2.299 5.529 1.016 8.239-.176.363-16.786 36.649.066 46.007 28.902 16.06 15.449 61.245 14.862 63.163-1.252 4.089-5.571 6.376-9.66 5.129-4.083-1.24-6.388-5.564-5.148-9.654.103-.351 10.114-35.277-7.579-45.1-17.1-9.503-17.511-30.081-13.132-47.726-27.286 21.062-32.101 72.061-32.156 72.659-.363 4.162-3.969 7.24-8.124 7.052-4.168-.224-7.41-3.708-7.331-7.882.205-10.506-2.033-19.64-5.045-27.093-1.536 6.775-4.234 13.78-8.105 21.001-31.031 57.882-6.697 87.025-5.644 88.235 2.783 3.212 2.487 8.093-.701 10.906-1.473 1.31-3.306 1.951-5.133 1.951z">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white"> 64,941+</h5>
                                <p class="descrip rs-white">Strong Workforce</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="rs-category-item-stats wow fadeIn" data-wow-delay="1.3s">
                            <div class="rs-category-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_6" viewBox="0 0 500 500">
                                    <g>
                                        <path d="m169.348 445.426h-122.733c-4.133 0-7.482-3.349-7.482-7.482v-276.414c0-4.133 3.349-7.482 7.482-7.482h122.733c4.133 0 7.482 3.349 7.482 7.482v276.414c0 4.133-3.349 7.482-7.482 7.482zm-115.251-14.963h107.769v-261.453h-107.769z">
                            ...
                            <div class="rs-category-content">
                                <h5 class="rs-category-title rs-white">43.7+ Lakh</h5>
                                <p class="descrip rs-white">Happy Customers</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="rs-faq-content-wrapper">
                            <div class="rs-section-title-wrapper">
                                ...
                                <h2 class="rs-section-title has-theme-green rs-split-text-enable split-in-fade">Do you have
        ...
        <section class="rs-testimonial-area section-space-bottom rs-testimonial-one primary-bg rs-swiper rs-about-five">
            <div class="container">
                ...
                <div class="rs-about-content-wrapper ">
                   <div class="rs-about-tab mb-4">
                        <ul class="nav nav-pills" id="history-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="history-item-two-tab" data-bs-toggle="pill" data-bs-target="#history-item-two" type="button" role="tab" aria-controls="history-item-two" aria-selected="false" tabindex="-1"> Lakshmi Finance
                                </button>
                            </li>
                        </ul>
                    </div>
                     <div class="rs-aobut-tab-content-wrapper ">
                        <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="1000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="false" data-delay="500" data-item="3" data-item-xl="3" data-item-lg="3" data-item-md="2" data-item-sm="1" data-item-xs="1" data-item-mobile="1" data-margin="30" data-margin-xl="30">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
        ...
        <!-- testimonial area start -->
        <section class="rs-contact-area section-space-top rs-contact-nine">
            <div class="container">
                <div class="row">
                    <div class="col-12">
