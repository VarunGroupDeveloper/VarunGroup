                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Agriculture</h1>
                            </div>
            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="rs-counter-item text-center">
                            <div class="rs-counter-inner">
                                <div class="rs-counter-icon mb-2">
                                    <img src="assets/images/icon/land.png" alt="Land Icon" style="width:70px;">
                                </div>
                                <div class="rs-counter-number-wrapper text-center">
                                    <span class="rs-counter-number odometer" data-count="7">00</span>
                                    <span class="prefix">Acres</span>
                                </div>
                                <span class="rs-counter-title">Land Under Cultivation</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="rs-counter-item text-center">
                            <div class="rs-counter-inner">
                                <div class="rs-counter-icon mb-2">
                                    <img src="assets/images/icon/trees.png" alt="Berries Icon" style="width:70px;">
                                </div>
                                <div class="rs-counter-number-wrapper">
                                    <span class="rs-counter-number odometer" data-count="50000">00</span>
                                    <span class="prefix">+</span>
                                </div>
                                <span class="rs-counter-title">Berries Harvested</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="rs-counter-item text-center">
                            <div class="rs-counter-inner">
                                <div class="rs-counter-icon mb-2">
                                    <img src="assets/images/icon/order.png" alt="Orders Icon" style="width:70px;">
                                </div>
                                <div class="rs-counter-number-wrapper">
                                    <span class="rs-counter-number odometer" data-count="1200">00</span>
                                    <span class="prefix">+</span>
                                </div>
                                <span class="rs-counter-title">Orders Fulfilled</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="rs-counter-item text-center">
                            <div class="rs-counter-inner">
                                <div class="rs-counter-icon mb-2">
                                    <img src="assets/images/icon/team.png" alt="Team Icon" style="width:70px;">
                                </div>
                                <div class="rs-counter-number-wrapper">
                                    <span class="rs-counter-number odometer" data-count="30">00</span>
                                    <span class="prefix">+</span>
                                </div>
                                <span class="rs-counter-title">Team Members</span>
                            </div>
                        </div>
                    </div>
    ...
    <!-- about area start -->
                              ...
                              About Us
                                ...
                                <div class="rs-about-author-info">
                                    <div class="rs-about-btn">
                                        <a class="rs-btn has-theme-orange has-icon has-bg" href="about.html">Explore More
                                            <span class="icon-box">
        ...
        <!-- about area end -->
       <!-- services style 03 -->
        <section class="rs-elements-services-area section-space-bottom rs-services-seven">
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        ...
                        Services
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade rs-black">Services Style 03</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-services-top">
                                <h5 class="rs-services-title underline has-theme-yellow"><a href="services-details.html">Hydro
                                        Energy </a></h5>
                                <div class="rs-services-icon-btn">
                                    <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                        <span class="icon-box">
                                 <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" width="23" height="15"
                                 ...
                                 <svg class="icon-second" xmlns="http://www.w3.org/2000/svg" width="23" height="15"
                                    viewBox="0 0 23 15" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                       d="M0 7.5C0 7.03976 0.367766 6.66667 0.821429 6.66667L20.1955 6.66667L15.0263 1.42259C14.7055 1.09715 14.7055 0.569515 15.0263 0.244079C15.3471 -0.0813589 15.8672 -0.0813589 16.188 0.244079L22.7594 6.91074C23.0802 7.23618 23.0802 7.76382 22.7594 8.08926L16.188 14.7559C15.8672 15.0814 15.3471 15.0814 15.0263 14.7559C14.7055 14.4305 14.7055 13.9028 15.0263 13.5774L20.1955 8.33333H0.821429C0.367766 8.33333 0 7.96024 0 7.5Z"
                                       fill="#F7C600"></path>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="rs-services-top">
                                <h5 class="rs-services-title underline has-theme-yellow"><a href="services-details.html"> Solar
                                        Energy </a></h5>
                                <div class="rs-services-icon-btn">
                                    <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                        <span class="icon-box">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            <div class="rs-services-top">
                                <h5 class="rs-services-title underline has-theme-yellow"><a href="services-details.html"> Bio
                                        Energy </a></h5>
                                <div class="rs-services-icon-btn">
                                    <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                        <span class="icon-box">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                            <div class="rs-services-top">
                                <h5 class="rs-services-title underline has-theme-yellow"><a href="services-details.html"> Wind
                                        Energy </a></h5>
                                <div class="rs-services-icon-btn">
                                    <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                        <span class="icon-box">
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-8 col-lg-9 col-md-10">
                        ...
                        Question
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Any questions for our company</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                            ...
                            <div class="accordion-wrapper">
                                <div class="accordion" id="accordionExampleTwo">
                                    ...
                                    <div class="rs-accordion-item">
                                        ...
                                        <div id="collapseTen" class="accordion-collapse collapse  show" data-bs-parent="#accordionExampleTwo">
                                            <div class="accordion-body">Randomised words which don’t look even slightly
                                                believable. If you are going to use a passage of Lorem Ipsum, you need to be sure
                                                there isn’t anything.</div>
                                        </div>
