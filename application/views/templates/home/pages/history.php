                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        ...
                        ABOUT VARUN GROUP
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">INDIA'S LEADING BUSINESS CONGLOMERATE SINCE 1950</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-12">
                        <div class="rs-progress-wrapper">
                            <div class="rs-progress-thumb">
                                <img src="assets/images/about/kesavarao.webp" alt="image">
                            </div>
                            <div class="rs-progress-content-wrapper">
        ...
        <!-- team area start -->
        <section class="rs-team-area rs-team-one has-theme-light-blue section-space">
            <div class="container has-large">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-light-blue rs-split-text-enable split-in-fade">The best
                                industry experts</h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-team-btn">
                            <a class="rs-btn has-theme-light-blue has-icon has-bg" href="team.html">View More Member
                                <span class="icon-box">
          ...
          <div class="container">
            ...
            <div class="row mb-4">
              <div class="col-12 position-relative">
                ...
                <div class="rs-portfolio-navigation d-inline-flex gap-2 position-absolute" style="top: 0; right: 0;">
                  <button class="swiper-button-prev rs-swiper-btn rs-nav-prev-1" tabindex="0" aria-label="Previous slide">
                    <i class="fa-regular fa-arrow-left"></i>
                  </button>
                  <button class="swiper-button-next rs-swiper-btn rs-nav-next-1" tabindex="0" aria-label="Next slide">
            ...
            <div class="row justify-content-center">
              <div class="col-xxl-9 col-xl-10">
                <div class="rs-history-tab-wrapper">
                  <div class="rs-history-tab-content-wrapper">
                    <div class="swiper rs-history-swiper">
                      <div class="swiper-wrapper">
        ...
        <!-- blog area start -->
        <section class="rs-blog-area section-space rs-blog-two has-theme-orange rs-swiper">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-7 col-lg-8">
                        ...
                        News &amp; Blog
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Discover the future factories and
                                industries
                            </h2>
                        </div>
                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rs-blog-item">
                                    ...
                                    <div class="rs-blog-content">
                                        ...
                                        <h5 class="rs-blog-title underline has-black"> <a href="blog-details.html">Construction of
                                                a
                            ...
                            <div class="swiper-slide">
                                <div class="rs-blog-item">
                                    ...
                                    <div class="rs-blog-content">
                                        ...
                                        <h5 class="rs-blog-title underline has-black"> <a href="blog-details.html"> Interactive
